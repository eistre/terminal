...
export default defineI18nConfig(() => ({
  ...
  messages: {
    ee: {
      ...
      auth: {
        name: 'Nimi',
        domains_failed: 'Lubatud domeenide päring ebaõnnestus',
        email: "juhan{'@'}ut.ee",
        valid_email: 'Ainult välja toodud domeenid on lubatud',
        only: 'Ainult',
        are_allowed: 'ja teised kokkuleppelised email aadressid on lubatud',
        ...
        auth_error_password: 'Vale parool',
        auth_error_not_found: 'Kasutajat ei leitud',
        auth_already_exists: 'Kasutaja juba eksisteerib',
        login: 'Logi sisse',
        create: 'Loo kasutaja',
        logout: 'Logi välja',
    ...
    en: {
      ...
      auth: {
        name: 'Name',
        domains_failed: 'Whitelisted domain fetch failed',
        email: "john{'@'}ut.ee",
        valid_email: 'Only whitelisted domains are allowed',
        only: 'Only',
        are_allowed: 'and other whitelisted emails are allowed',
        ...
        auth_error_not_found: 'User not found',
        auth_already_exists: 'User already exists',
        login: 'Login',
        create: 'Sign up',
        logout: 'Log out',
