...
The comparison covers February 2026 and March 2026, which represented the more active and less active parts of the observation period, respectively. % TODO "the more active and less active" sounds a bit funny, perhaps changes it with something
...
At the time of writing, UT HPC did not yet provide a per-namespace Kubernetes cost reporting tool\footnote{Based on private communication with UT HPC support.}. % TODO is "at the time of writing" academically formal, or should we rephrase it?
