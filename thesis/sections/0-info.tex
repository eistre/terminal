...
\begin{otherInfo}{estonian}{Veebipõhise Linuxi käsurea õppekeskkonna kaasajastamine ja kulude vähendamine}
  \begin{abstract}
    ...
    Käesoleva lõputöö eesmärk oli kujundada olemasolev platvorm ümber jätkusuutlikumaks, säilitades samal ajal selle haridusliku eesmärgi ja põhilise kasutusloogika.
