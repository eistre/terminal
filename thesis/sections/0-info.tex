...
\begin{info}
  \begin{abstract}
    ...
    The aim of this thesis was to modernize and architecturally redesign the environment while preserving its educational purpose and core workflow.
...
\begin{otherInfo}{estonian}{Veebipõhise Linuxi käsurea õppekeskkonna kaasajastamine ja kulude vähendamine}
  \begin{abstract}
    ...
    Käesoleva lõputöö eesmärk oli olemasolevat platvormi kaasajastada ja arhitektuuriliselt ümber kujundada, säilitades samal ajal selle haridusliku eesmärgi ja põhilise kasutusloogika.
