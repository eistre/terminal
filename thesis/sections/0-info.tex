...
\begin{info}
  \begin{abstract}
    ...
    These versions demonstrated the educational value of browser-based Linux practice, but they also revealed shortcomings related to cost, maintainability, and operational reliability.
    The aim of this thesis was to modernize the environment while preserving its educational purpose and core workflow. % TODO perhaps redesign and modernize?
...
\begin{otherInfo}{estonian}{Veebipõhise Linuxi käsurea õppekeskkonna kaasajastamine ja kulude vähendamine}
  \begin{abstract}
    Linux ja selle käsurida mängivad olulist rolli Tartu Ülikooli õppeainetes ``Operatsioonisüsteemid'' ja ``Andmeturve''.
    Nende ainete praktiliste harjutuste toetamiseks loodi varasemate lõputööde raames veebipõhine Linuxi käsurea õppekeskkond, mida hiljem laiendati pilvepõhiseks platvormiks.
    Need varasemad versioonid näitasid, et brauseripõhine Linuxi harjutamine on hariduslikult väärtuslik, kuid neil ilmnesid ka puudused, mis on seotud kulude, hooldatavuse ja töökindlusega.
    Käesoleva lõputöö eesmärk oli kujundada olemasolev platvorm ümber jätkusuutlikumaks, säilitades samal ajal selle haridusliku eesmärgi ja põhilise kasutusloogika. % TODO perhaps "kaasajastada" and not jätkusuutlikumaks? "ümber kujundada ja kaasajastada"
    ...
    Testimine, mis viidi läbi õppeaines ``Andmeturve'' 2026.\ aasta veebruaris ja märtsis, näitas, et uuendatud platvorm säilitas esialgse kasutusloogika.
    Üliõpilased said keskkonda sisse logida, alustada interaktiivseid Linuxi sessioone ja lahendada ettenähtud ülesandeid ilma märkimisväärsete probleemideta.
