...
Linux command-line knowledge remains important in many systems-oriented computing roles, including system administration, software development, and computer security.
...
This thesis extends that baseline by addressing these limitations while preserving the established educational workflow.
...
The application was containerized and deployed using Azure Container Apps (ACA)\footnote{\url{https://azure.microsoft.com/en-us/products/container-apps}} for the web application and Azure Kubernetes Service (AKS)\footnote{\url{https://azure.microsoft.com/en-us/products/kubernetes-service}} for per-user Linux environments~\cite{eistre_2024}.
...
In addition to the cost and maintainability issues described above, the previous system exposed several further operational and usability limitations that are relevant to the later redesign.
