...
Practical command-line skills continue to be relevant for topics such as system administration, software development, and security. % TODO I feel like something might be missing here for "security"? cyber security? systems security?
...
Consequently, a web-based Linux learning environment offers educational value by supporting hands-on practice with command-line skills. % TODO maybe this is just me, or would it make sense to have "by supporting command-line skills with hands-on practice" instead? I feel like the current phrasing is a bit awkward, but maybe it's just me
...
The thesis also adopts a reproducible deployment approach based on Helm\footnote{\url{https://helm.sh/}} and Terraform\footnote{\url{https://developer.hashicorp.com/terraform}} and evaluates the revised platform on UT HPC\footnote{\url{https://hpc.ut.ee/}}, Microsoft Azure\footnote{\url{https://azure.microsoft.com/}}, and Amazon Web Services\footnote{\url{https://aws.amazon.com/}}. % TODO helm and terraform and evaluates feels a bit weird?
