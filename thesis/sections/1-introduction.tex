...
Appendices~\ref{app:azure-cost-evidence}--\ref{app:uthpc-monitoring-evidence} provide the supporting evidence used in the cost comparison, including Azure and AWS billing screenshots and UT HPC monitoring material.
Appendix~\ref{app:accompanying-files} describes the accompanying project files.
