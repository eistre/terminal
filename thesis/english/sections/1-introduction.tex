...
Halapuu~\cite{halapuu_eestikeelse_nodate} developed the initial proof-of-concept web-based Linux command-line learning environment, and Eistre~\cite{eistre_veebipohise_nodate} extended it into a cloud-hosted learning platform designed for continuous use.
