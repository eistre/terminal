...
The thesis also adopts a reproducible deployment approach based on Helm\footnote{\url{https://helm.sh/}} and Terraform\footnote{\url{https://developer.hashicorp.com/terraform}} and evaluates the revised platform in UT HPC\footnote{\url{https://hpc.ut.ee/}}, Microsoft Azure\footnote{\url{https://azure.microsoft.com/}}, and Amazon Web Services\footnote{\url{https://aws.amazon.com/}}.
...
Chapter~\ref{sec:deployment-environments-and-infrastructure-setup} explains how the redesigned system was deployed in UT HPC, Microsoft Azure, and Amazon Web Services.
...
The appendices provide brief deployment instructions together with the AWS cost evidence and the UT HPC monitoring material used in the deployment cost comparison.
