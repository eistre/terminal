...
For orientation, Figure~\ref{fig:updated-learning-environment} shows the revised learning environment with its task list, completed tasks highlighted in green, and a browser-based Linux terminal.
