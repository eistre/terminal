...
As a result, the thesis produced a redesigned implementation of the platform and evaluated it across UT HPC, Microsoft Azure, and Amazon Web Services.
...
Students were able to access the web-based environment, open interactive Linux sessions, and complete the relevant course tasks in the deployed environments.
Throughout the observed period, no major issues were identified.
...
Furthermore, the cross-environment deployment showed that the redesigned architecture could be deployed across UT HPC, Microsoft Azure, and Amazon Web Services while preserving the core functionality of the application.
...
The evaluation suggests that, when institutional support and integration are available, UT HPC appeared to be the strongest long-term deployment option among the environments evaluated.
...
Because the evaluation was based on real course use, unequal traffic across environments, and an estimated UT HPC cost model rather than on a controlled experiment, these conclusions should be interpreted as limited to the observed deployment period.
