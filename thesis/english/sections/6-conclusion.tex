...
The evaluation conducted in February and March 2026 showed that the revised environment preserved the intended educational workflow throughout the observed course period.
...
Because the evaluation was based on observed course usage and deployment testing, unequal traffic across environments, and an estimated UT HPC cost model rather than on a controlled experiment, these conclusions should be interpreted as limited to the observed deployment period.
