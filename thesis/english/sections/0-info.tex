...
The redesigned environment was deployed and evaluated in UT HPC, Microsoft Azure, and Amazon Web Services.
...
Among the environments tested in this evaluation, UT HPC appeared to be the strongest option for institutional use, while Azure appeared to be the strongest public cloud alternative.
\end{abstract}
