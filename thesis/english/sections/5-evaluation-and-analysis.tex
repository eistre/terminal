...
This, together with the architectural continuity described in chapter~\ref{sec:revised-architecture-and-implementation}, suggests that the modernization effort did not interfere with the environment's primary purpose of providing isolated Linux environments for interactive course use through a web interface.
