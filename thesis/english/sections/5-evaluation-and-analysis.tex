...
The learning environment was used across all three deployments without major issues throughout the evaluation period.
...
From the perspective of future use, the results of this evaluation suggest that UT HPC is the strongest long-term deployment option when institutional support and integration are available, whereas Azure is the strongest self-contained public cloud deployment option among the environments evaluated.
