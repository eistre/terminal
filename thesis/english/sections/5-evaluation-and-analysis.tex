...
The deployments were used during practical session 1\footnote{\url{https://courses.cs.ut.ee/2026/turve/spring/Main/Praktikum1}} of the course.
...
This arrangement ensured that course traffic reached all three deployment environments.
...
These figures indicate that UT HPC was the most widely used environment.
...
Within this evaluation, Azure was the most suitable public cloud option because it showed the lowest idle footprint among the public cloud deployments while remaining within a single provider ecosystem.
