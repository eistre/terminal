...
This was mainly because UT HPC was the university-hosted deployment and already supported the institutional access model used in the course.
...
These figures showed that UT HPC was the most widely used environment.
...
At the time of this thesis, UT HPC did not yet provide a per-namespace Kubernetes cost reporting tool\footnote{Based on private communication with UT HPC support.}
...
Table~\ref{tab:environment-cost-comparison} shows that UT HPC had the lowest direct monthly cost in this evaluation.
...
UT HPC appears to be the strongest fit for long-term institutional use in this evaluation, as it combines the lowest observed cost with university-managed hosting and integration with institutional access management.
...
From the perspective of future teaching use, UT HPC appears to be the most suitable long-term deployment when institutional support and integration are available, whereas Azure represents the most suitable self-contained public cloud deployment.
