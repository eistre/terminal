...
At the same time, the session containers are constrained by a relatively fixed Dockerfile-based configuration that creates task-specific files and folders in a predefined way.
